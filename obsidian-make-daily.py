...
home_root = "/mnt/c/Users/mattr/Documents/Obsidian/OB-SecondBrain-WDS"
config_file = "_config/.notes.md"
open_tasks_template_file = home_root + "/_templates/OpenTasks.md"

# daily_notes_root s/b relative to the root of the vault
#  ie  /__BulletJournal/2022
daily_notes = get_config_value("daily_notes_root")
daily_notes_path = home_root + daily_notes
weather_location = get_config_value("weather_zip")
daily_notes_file = os.path.join(daily_notes_path, get_daily_notes_filename())
